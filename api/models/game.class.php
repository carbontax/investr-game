...
//            	$p->fetchPortfolio();
    ...
    public function fetchPlayer($debug = false) {
...
/*    public function netWorth($player) {
    ...
    public function fetchSecurities($debug = false) {
        ...
        //$debug && error_log('fetchSecurities - query = ' . $query . '; game = ' . $this->id . '; year = ' . $this->year);
